...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyspellchecker-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9264&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyspellchecker-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyspellchecker` can be installed with:

```
conda install pyspellchecker
```

It is possible to list all of the versions of `pyspellchecker` available on your platform with:
